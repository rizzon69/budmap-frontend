-- ========================================
-- BudMap Database Creation Script
-- Complete database setup for BudMap project
-- ========================================

-- Drop existing database if it exists
DROP DATABASE IF EXISTS budmap;
...
COMMENT ON DATABASE budmap IS 'BudMap - Budget Allocation Application for SMEs, NGOs, and Educational Institutions in Nepal';

-- Connect to the budmap database
\c budmap
...
CREATE TABLE organizations (
    ...
    type VARCHAR(50) NOT NULL CHECK (type IN ('ngo', 'sme', 'educational', 'government', 'other')),
    email VARCHAR(255) NOT NULL UNIQUE,
    phone VARCHAR(20),
    address TEXT,
    website VARCHAR(255),
    fiscal_year_start VARCHAR(20) DEFAULT 'July',
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'BudMap Database Created Successfully!';
    RAISE NOTICE '========================================';
    RAISE NOTICE '';
    RAISE NOTICE 'Database: budmap';
    RAISE NOTICE 'Tables: 12';
    RAISE NOTICE 'Indexes: 18';
    RAISE NOTICE 'Triggers: 6';
    RAISE NOTICE '';
    RAISE NOTICE 'Next steps:';
    RAISE NOTICE '1. Update your .env file with the correct password';
    RAISE NOTICE '2. Run: npm run migrate (to populate sample data)';
    RAISE NOTICE '';
